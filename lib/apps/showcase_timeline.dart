  ...
  Widget build(BuildContext context) {
    return Showcase(
      ...
      theme: TemplateThemeData(
        ...
        titleTextStyle: GoogleFonts.nanumPenScript(fontSize: 80),
        descriptionTextStyle: GoogleFonts.jura(fontSize: 24, height: 1.2),
...
class _ShowcaseTimelineApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      theme: ThemeData(
        brightness: Brightness.dark,
        textTheme: GoogleFonts.nanumPenScriptTextTheme(Theme.of(context).textTheme).apply(bodyColor: Colors.white),
